import { Company, Users } from '@/components/configuration';
import { Tabs, TabsList, TabsTrigger, TabsContent } from '@/components/ui/tabs';
import { createFileRoute, useRouter } from '@tanstack/react-router'

type TabSearch = { tab: string };

export const Route = createFileRoute('/_authenticated/_dashboardLayout/configuration/')({
...
function Configuration() {
  ...
  return (
    <Tabs value={tab} className="w-full h-full rounded" onValueChange={onTabChange}>
