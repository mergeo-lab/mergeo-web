...
function OrdersPage() {
    ...
    return (
        <>
            ...
            <OrderConfig
                companyId={companyId}
                callback={handleOrderConfigCallback}
                openDialog={configDialogOpen}
                onCancel={handleOrderConfigCancel}
            />
            <CartSheet
