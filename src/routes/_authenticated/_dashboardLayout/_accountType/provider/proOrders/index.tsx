...
export default function Sells() {
    ...
    const { data, isLoading, isError, refetch } = useQuery({
        queryKey: ['sellPreOrders', companyId],
        queryFn: ({ queryKey }) => {
                                ...
                                <div className="relative max-h-[750px] w-full overflow-y-auto">
                                    <Table className='hover:bg-white w-full'>
                                        ...
                                        <TableBody>
                                            {data
                                                .sort((a, b) => {
                                                    // First sort by preOrderNumber (high to low)
                                                    const orderNumberComparison = b.preOrderNumber - a.preOrderNumber;
                                                    if (orderNumberComparison !== 0) {
                                                        return orderNumberComparison;
                                                    }
