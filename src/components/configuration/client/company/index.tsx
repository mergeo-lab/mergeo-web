...
const MemoizedFormItem = memo(({ value }: { value: number | undefined }) => (
    <FormItem>
            ...
            <div className="flex flex-col justify-between w-4/6">
                        ...
                        <form className='space-y-8 w-full pr-10'>
                            <div className='grid grid-cols-2 gap-10'>
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input className={cn("", { 'disabledStyle': !isEditing })} {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={true} value={company?.razonSocial} className="disabledStyle" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            </div>
                            <div className='grid grid-cols-2 gap-10'>
                                <MemoizedFormItem value={company?.cuit} />
                                <FormField
                                    name="activity"
                                    disabled={!isEditing}
                                    render={({ field }) => (
                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <GoogleAutoComplete
                                                    ...
                                                    addressRemoved={() => {
                                                        field.value?.name && form.setValue('branch.address', {
                                                            id: "",
                ...
                <CardFooter className='w-full'>
                    <div className='flex flex-col-reverse md:flex-row justify-end items-center min-h-20 gap-2'>
                        {isEditing ? (
                            <>
                                <Button variant='secondary' onClick={handleCancelEdit} className='min-w-[200px]'>
                                    Cancelar
                                </Button>
                                <Button onClick={form.handleSubmit(onSubmit)} className='min-w-[200px]'>
                                    Guardar
                                </Button>
                            </>
                        ) : (
