  ...
  theme: {
  	extend: {
  		...
  		keyframes: {
			...
			'pulseSubtle': {
				'0%': {
					background: 'linear-gradient(to right, hsl(var(--info)), rgb(59, 130, 246))'
				},
				'25%': {
					background: 'rgb(59, 130, 246)'
				},
				'50%': {
					background: 'linear-gradient(to right, rgb(59, 130, 246), hsl(var(--info)))'
				},
				'75%': {
			...
			'pulse-5s': 'pulse 5s ease-in-out infinite'
		},
		transitionDelay: {
			'800': '800ms'
		}
